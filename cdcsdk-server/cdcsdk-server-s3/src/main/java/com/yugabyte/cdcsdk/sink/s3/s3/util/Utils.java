...
public class Utils {
    ...
    /**
     * Get the filename for the respective record view. Appends the Value, Key or
     * Header file
     * extensions before the existing file extension. Typically unchanged for the
     * Value view.
     *
     * @param recordView       the record view (key, header or value)
     * @param filename         the current name of the file, equivalent
     * @param initialExtension the file extension without the appended view
     *                         extension, eg. .avro
    ...
    /**
     * Returns a safe string representation of the sink record that can be logged in
     * the logs.
     *
