...
import com.yugabyte.cdcsdk.sink.cloudstorage.storage.config.StorageSinkConnectorConfig;
...
public class S3SinkConnectorConfig extends StorageSinkConnectorConfig {
     ...
     */
    public static final String CREDENTIALS_PROVIDER_CONFIG_PREFIX = CREDENTIALS_PROVIDER_CLASS_CONFIG.substring(
            0,
    ...
    public AWSCredentialsProvider getCredentialsProvider() {
        try {
            AWSCredentialsProvider provider = ((Class<? extends AWSCredentialsProvider>) getClass(
                    S3SinkConnectorConfig.CREDENTIALS_PROVIDER_CLASS_CONFIG)).newInstance();
    ...
    public static ConfigDef getConfig() {
        ...
        addAllConfigKeys(visible, StorageCommonConfig.newConfigDef(), skip);
        return visible;
    }
