 ...
 *
 * <p>
 * In particular, the compression here is not used for Avro since the
 * Avro libraries have compression codecs built in.
 *
 * <p>
 * Closely modeled on {@link org.apache.kafka.common.record.CompressionType}.
 * </p>
 */
public enum CompressionType {
    ...
    /**
     * Wrap {@code out} with a filter that will compress data with this
     * CompressionType.
     *
    ...
    /**
     * Wrap {@code in} with a filter that will decompress data with this
     * CompressionType.
     *
     ...
     *
     * <p>
     * Implementations of this method should make sure to handle the case
