...
import static com.yugabyte.cdcsdk.sink.cloudstorage.s3.util.Utils.sinkRecordToLoggableString;
...
public class KeyValueHeaderRecordWriterProvider
    ...
    public RecordWriter getRecordWriter(S3SinkConnectorConfig conf, String filename) {
        ...
        RecordWriter keyWriter = keyProvider == null ? null : keyProvider.getRecordWriter(conf, strippedFilename);
        RecordWriter headerWriter = headerProvider == null ? null : headerProvider.getRecordWriter(conf, strippedFilename);
