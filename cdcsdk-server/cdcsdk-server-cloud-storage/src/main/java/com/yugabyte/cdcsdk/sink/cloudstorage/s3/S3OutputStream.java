 ...
 *
 * <p>
 * The implementation has borrowed the general structure of Hadoop's
 * implementation.
 */
public class S3OutputStream extends OutputStream {
    ...
    /**
     * Return the given Supplier value, converting any thrown AmazonClientException
     * object
    ...
    private class MultipartUpload {
        ...
        public void complete() throws IOException {
            ...
            CompleteMultipartUploadRequest completeRequest = new CompleteMultipartUploadRequest(bucket, key, uploadId,
                    partETags);
