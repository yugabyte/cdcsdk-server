 ...
 *
 * <p>
 * Depending on the storage implementation, an object corresponds to a file or a
 * directory in a
 * distributed filesystem or an object in an object store. Similarly, a path
 * corresponds to an
 * actual path in a distributed filesystem or a lookup key in an object store.
 *
 * @param <C> The configuration of this storage.
 * @param <R> Object listing that is returned when searching the storage
 *            contents.
 */
public interface Storage<C, R> extends Closeable {
     ...
     *
     * <p>
     * In stores supporting weak consistency models (e.g. eventual consistency) this
     * operation
     * might affect semantics.
     *
     * @param path the path to the object.
     * @return true if object exists, false otherwise.
     * @throws org.apache.kafka.connect.errors.DataException if the call to the
     *                                                       underlying
     *                                                       distributed storage
     *                                                       failed.
     */
    ...
    /**
     * Creates an object container, e.g. a directory or a bucket (optional
     * operation).
     *
     * @param path the path of the container
     * @return true if the container does not exist and was successfully created;
     *         false otherwise.
     */
     ...
     *
     * <p>
     * In stores supporting weak consistency models (e.g. eventual consistency) the
     * success of this
     * operation might depend on successfully completing all operations on the
     * output stream. For
     * instance successfully closing the stream after writing all the data.
     ...
     * In stores supporting weak consistency models (e.g. eventual consistency) the
     * result of this
     * operation might not be correspond to the most recent state of the store. For
     * instance, created
