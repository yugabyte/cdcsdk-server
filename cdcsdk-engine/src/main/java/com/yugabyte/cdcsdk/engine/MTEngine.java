...
public final class MTEngine implements DebeziumEngine<SourceRecord> {
    ...
    /**
     * A required field that specifies unique integer id of the task.
     */
    ...
    /**
     * A required field that specifies the total number of tasks.
     */
    ...
    public static final class BuilderImpl implements Builder {
        ...
        public MTEngine build() {
            ...
            return new MTEngine(config, classLoader, clock,
    ...
    /**
     * A builder to set up and create {@link MTEngine} instances.
     */
    @Deprecated
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MTEngine.class);
    ...
    public void run() {
        if (runningThread.compareAndSet(null, Thread.currentThread())) {
            ...
            final Integer taskId = config.getInteger(TASK_ID);
            final Integer maxTasks = config.getInteger(MAX_TASKS);
