 ...
 * {@link com.yugabyte.cdcsdk.engine.EmbeddedEngine} instance that wraps and completely manages a single standard Debezium connector.
 ...
 * <p>
 * Once the application has configured its {@link com.yugabyte.cdcsdk.engine.EmbeddedEngine} instance and is ready to start receiving
 ...
 * {@link com.yugabyte.cdcsdk.engine.EmbeddedConnector#run()} method will start the standard Debezium connector and continuously
 * deliver any data changes events to the application.
 * <p>
 * When the application is ready to shut down the engine, it should call {@link com.yugabyte.cdcsdk.engine.EmbeddedEngine#stop()} on the
 ...
 * {@link com.yugabyte.cdcsdk.engine.EmbeddedEngine#await(long, java.util.concurrent.TimeUnit)} method.
