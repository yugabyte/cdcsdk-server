...
public class EmbeddedEngineTest extends AbstractConnectorTest {
    ...
    public void interruptedOffsetCommitShutsDown() throws Exception {
        ...
        Configuration config = Configuration.create()
                ...
                .with(MTEngine.TASK_ID, "0")
                .with(MTEngine.MAX_TASKS, "1")
                .with(MTEngine.CONNECTOR_CLASS, SimpleSourceConnector.class)
                .with(StandaloneConfig.OFFSET_STORAGE_FILE_FILENAME_CONFIG, OFFSET_STORE_PATH)
                .with(MTEngine.OFFSET_STORAGE, InterruptingOffsetStore.class)
                .build();
    ...
    public void shouldWorkToUseCustomChangeConsumer() throws Exception {
        ...
        Configuration config = Configuration.copy(connectorConfig)
                ...
                .with(MTEngine.TASK_ID, "0")
                .with(MTEngine.MAX_TASKS, "1")
                .with(MTEngine.CONNECTOR_CLASS, FileStreamSourceConnector.class)
                .with(StandaloneConfig.OFFSET_STORAGE_FILE_FILENAME_CONFIG, OFFSET_STORE_PATH)
                .with(MTEngine.OFFSET_FLUSH_INTERVAL_MS, 0)
                .build();
    ...
    public void shouldRunDebeziumEngine() throws Exception {
        ...
        props.setProperty("name", "cdcsdk-engine");
        ...
        props.setProperty("taskId", "0");
        props.setProperty("maxTasks", "1");
    ...
    public void shouldExecuteSmt() throws Exception {
        ...
        props.setProperty("transforms.filter.type", "com.yugabyte.cdcsdk.engine.EmbeddedEngineTest$FilterTransform");
